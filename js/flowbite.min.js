    ...
    return function() {
            ...
            853: function(t, e, i) {
                    ...
                    fn: function(t) {
                        ...
                        Object.keys(e.elements).forEach((function(t) {
                            var i = e.styles[t] || {}
                              , n = e.attributes[t] || {}
                              , o = e.elements[t];
                            P(o) && A(o) && (Object.assign(o.style, i),
                    ...
                    effect: function(t) {
                        ...
                        function() {
                            Object.keys(e.elements).forEach((function(t) {
                                ...
                                P(n) && A(n) && (Object.assign(n.style, r),
                ...
                function V(t, e, i) {
                    ...
                    var n = t.getBoundingClientRect()
                      , o = 1
                      , r = 1;
                    e && P(t) && (o = t.offsetWidth > 0 && q(n.width) / t.offsetWidth || 1,
                ...
                function X(t) {
                    for (var e = T(t), i = U(t); i && F(i) && "static" === R(i).position; )
                        i = U(i);
                    return i && ("html" === A(i) || "body" === A(i) && "static" === R(i).position) ? e : i || function(t) {
                        var e = /firefox/i.test(H());
                        if (/Trident/i.test(H()) && P(t) && "fixed" === R(t).position)
                            return null;
                        var i = K(t);
                ...
                var Z = {
                    ...
                    phase: "main",
                    fn: function(t) {
                        var e, i = t.state, a = t.name, l = t.options, d = i.elements.arrow, u = i.modifiersData.popperOffsets, p = I(i.placement), f = Y(p), h = [s, r].indexOf(p) >= 0 ? "height" : "width";
                        if (d && u) {
                            var g = function(t, e) {
                ...
                function et(t) {
                    ...
                    if (h) {
                        var A = X(i)
                          , j = "clientHeight"
                          , P = "clientWidth";
                        if (A === T(i) && "static" !== R(A = N(i)).position && "absolute" === p && (j = "scrollHeight",
                        P = "scrollWidth"),
                        c === n || (c === s || c === r) && l === d)
                            x = o,
                            b -= (v && A === k && k.visualViewport ? k.visualViewport.height : A[j]) - a.height,
                            b *= f ? 1 : -1;
                        if (c === s || (c === n || c === o) && l === d)
                            O = r,
                            y -= (v && A === k && k.visualViewport ? k.visualViewport.width : A[P]) - a.width,
                            y *= f ? 1 : -1
                    }
                    var C, S = Object.assign({
                        position: p
                    }, h && tt), I = !0 === g ? function(t) {
                        var e = t.x
                          , i = t.y
                    ...
                    return y = I.x,
                    b = I.y,
                    f ? Object.assign({}, S, ((C = {})[x] = L ? "0" : "",
                    C[O] = E ? "0" : "",
                    C.transform = (k.devicePixelRatio || 1) <= 1 ? "translate(" + y + "px, " + b + "px)" : "translate3d(" + y + "px, " + b + "px, 0)",
                    C)) : Object.assign({}, S, ((e = {})[x] = L ? b + "px" : "",
                    e[O] = E ? y + "px" : "",
                    e.transform = "",
                    e))
                }
                ...
                function gt(t, e, i) {
                    return e === p ? ht(function(t, e) {
                        ...
                        var e, i = N(t), n = lt(t), o = null == (e = t.ownerDocument) ? void 0 : e.body, r = D(i.scrollWidth, i.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), s = D(i.scrollHeight, i.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), a = -n.scrollLeft + dt(t), c = -n.scrollTop;
                ...
                function mt(t) {
                    var e, i = t.reference, a = t.element, c = t.placement, u = c ? I(c) : null, p = c ? $(c) : null, f = i.x + i.width / 2 - a.width / 2, h = i.y + i.height / 2 - a.height / 2;
                    switch (u) {
                    case n:
                        e = {
                            x: f,
                ...
                var _t = {
                    ...
                    fn: function(t) {
                        ...
                        if (!e.modifiersData[d]._skip) {
                            ...
                            e.placement !== D && (e.modifiersData[d]._skip = !0,
                            e.placement = D,
                            e.reset = !0)
                        }
                    },
                ...
                var xt = {
                    ...
                    fn: function(t) {
                        ...
                        if (A) {
                            if (d) {
                                var H, B = "y" === x ? n : s, V = "y" === x ? o : r, z = "y" === x ? "height" : "width", R = A[x], F = R + w[B], N = R - w[V], K = y ? -j[z] / 2 : 0, U = L === l ? T[z] : j[z], J = L === l ? -j[z] : -T[z], Q = e.elements.arrow, Z = y && Q ? W(Q) : {
                                    width: 0,
                                    height: 0
                                    ...
                                    bottom: 0,
                                    left: 0
                                }, et = tt[B], it = tt[V], nt = G(0, T[z], Z[z]), ot = O ? T[z] / 2 - K - nt - et - C.mainAxis : U - nt - et - C.mainAxis, rt = O ? -T[z] / 2 + K + nt + it + C.mainAxis : J + nt + it + C.mainAxis, st = e.elements.arrow && X(e.elements.arrow), at = st ? "y" === x ? st.clientTop || 0 : st.clientLeft || 0 : 0, ct = null != (H = null == S ? void 0 : S[x]) ? H : 0, lt = R + rt - ct, dt = G(y ? M(F, R + ot - ct - at) : F, R, y ? D(N, lt) : N);
                                A[x] = dt,
                                q[x] = dt - R
                            }
                            if (p) {
                                var ut, pt = "x" === x ? n : s, ft = "x" === x ? o : r, ht = A[k], gt = "y" === k ? "height" : "width", vt = ht + w[pt], mt = ht - w[ft], _t = -1 !== [n, s].indexOf(E), bt = null != (ut = null == S ? void 0 : S[k]) ? ut : 0, wt = _t ? vt : ht - T[gt] - j[gt] - bt + C.altAxis, Et = _t ? ht + T[gt] + j[gt] - bt - C.altAxis : mt, Lt = y && _t ? function(t, e, i) {
                                    var n = G(t, e, i);
                                    return n > i ? i : n
                ...
                function kt(t, e, i) {
                    void 0 === i && (i = !1);
                    var n, o, r = P(e), s = P(e) && function(t) {
                    ...
                    P(e) ? ((d = V(e, !0)).x += e.clientLeft,
                    d.y += e.clientTop) : a && (d.x = dt(a))),
                    {
                  ...
                  , o = function() {
                    ...
                    t.prototype.open = function(t) {
                        ...
                        this._options.alwaysOpen || this._items.map((function(t) {
                            var e, i;
                            t !== o && ((e = t.triggerEl.classList).remove.apply(e, n._options.activeClasses.split(" ")),
            ...
            922: function(t, e) {
                ...
                var n = {
                  ...
                  , o = function() {
                    ...
                    return t.prototype._init = function() {
                        var t = this;
                        this._triggerEl && (this._triggerEl.hasAttribute("aria-expanded") ? this._visible = "true" === this._triggerEl.getAttribute("aria-expanded") : this._visible = !this._targetEl.classList.contains("hidden"),
                ...
                e.initDrawers = function() {
                    ...
                    document.querySelectorAll("[data-drawer-target]").forEach((function(e) {
                        ...
                        if (s) {
                            ...
                            console.error("Drawer with id ".concat(i, " not found. Are you sure that the data-drawer-target attribute points to the correct drawer id?"))
                    }
                    )),
                ...
                var r = i(853)
                  ...
                  , a = function() {
                    ...
                    t.prototype._createPopperInstance = function() {
                        return (0,
                        r.createPopper)(this._triggerEl, this._targetEl, {
                ...
                e.initModals = function() {
                    ...
                    document.querySelectorAll("[data-modal-target]").forEach((function(e) {
                        ...
                        if (s) {
                            ...
                            console.error("Modal with id ".concat(i, " does not exist. Are you sure that the data-modal-target attribute points to the correct modal id?."))
                    }
                    )),
                    document.querySelectorAll("[data-modal-toggle]").forEach((function(e) {
                        ...
                        if (s) {
                            ...
                            console.error("Modal with id ".concat(i, " does not exist. Are you sure that the data-modal-toggle attribute points to the correct modal id?"))
                    }
                    )),
                    document.querySelectorAll("[data-modal-show]").forEach((function(e) {
                        ...
                        if (document.getElementById(i)) {
                            ...
                            console.error("Modal with id ".concat(i, " does not exist. Are you sure that the data-modal-show attribute points to the correct modal id?"))
                    }
                    )),
                    document.querySelectorAll("[data-modal-hide]").forEach((function(e) {
                        ...
                        if (document.getElementById(i)) {
                            ...
                            console.error("Modal with id ".concat(i, " does not exist. Are you sure that the data-modal-hide attribute points to the correct modal id?"))
                    }
                    ))
                }
                ,
                  ...
                  , o = function() {
                    ...
                    t.prototype.show = function(t, e) {
                        ...
                        (r !== this._activeTab || e) && (this._items.map((function(t) {
                            var e, i;
                            t !== r && ((e = t.triggerEl.classList).remove.apply(e, o._options.activeClasses.split(" ")),
        ...
        return function() {
            ...
            var e = i(902)
              ...
              , f = i(671)
              , h = i(947);
            new h.default("load",[e.initAccordions, r.initCollapses, o.initCarousels, a.initDismisses, l.initDropdowns, d.initModals, c.initDrawers, p.initTabs, f.initTooltips, u.initPopovers, s.initDials]).init(),
            t.default = {
                Accordion: e.default,
                Carousel: o.default,
                Collapse: r.default,
